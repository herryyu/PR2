...
\mkpar{0.5}
\refred{permissions@oreilly.com}
\mkpar{0.5}
...
频资源。对于更多信息，请访问\refred{http://oreilly.com}。
...
与本书有关的评论和问题，请发给出版社：
    \begin{quote}
        ...
        707-829-0104（传真）
    \end{quote}
欢迎访问本书主页，我们于此列出了勘误表、示例以及其它额外信息。请通过\refred{https://oreil.ly/programming-rust-2e}来访
问。
\mkpar{1}
通过发送电邮至\refred{bookquestions@oreilly.com}以提出关于本书的评论或者技术问题。
\mkpar{1}
访问\refred{http://www.oreilly.com}获得更多有关我们的书籍和课程的信息。
\mkpar{1}
在Facebook上找到我们: \refred{http://facebook.com/oreilly}
\mkpar{1}
在Twitter上关注我们: \refred{http://twitter.com/oreillymedia}
\mkpar{1}
在Youtube上关注我们: \refred{http://youtube.com/oreillymedia}
